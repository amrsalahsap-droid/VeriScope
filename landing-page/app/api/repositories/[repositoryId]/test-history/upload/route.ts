...
export async function POST(
  ...
  try {
    ...
    const runName = formData.get("run_name") as string | null;
    ...
    if (runName) backendFormData.append("run_name", runName);
    ...
    const res = await fetch(
      `${BACKEND}/github/repositories/${repositoryId}/test-history/upload`,
      {
        method: "POST",
        headers: {
