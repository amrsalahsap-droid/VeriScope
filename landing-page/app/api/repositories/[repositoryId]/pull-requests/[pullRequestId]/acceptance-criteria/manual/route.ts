...
export async function POST(
  ...
  try {
    ...
    const res = await fetch(`${BACKEND}/api/repositories/${repositoryId}/pull-requests/${pullRequestId}/acceptance-criteria/manual`, {
      method: "POST",
      headers: {
    ...
    // Disable caching to ensure fresh readiness state
