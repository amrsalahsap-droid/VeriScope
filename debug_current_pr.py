"""
Debug the current PR the user is on.
Repository ID: e5ba9d10-82d7-475e-bd87-7d1c7eb0acd7
Pull Request ID: fd36accb-d07b-4558-ade6-2d3ea843bcc1
"""
...
REPOSITORY_ID = "e5ba9d10-82d7-475e-bd87-7d1c7eb0acd7"
PULL_REQUEST_ID = "fd36accb-d07b-4558-ade6-2d3ea843bcc1"

def main():
    print(f"Debugging current PR")
